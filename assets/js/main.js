...
window.addEventListener('scroll', () => {
    if (window.scrollY > 50) {
        // Scrolled State
        navbar.classList.add('bg-black/80', 'shadow-[0_16px_40px_0_rgba(0,0,0,0.4)]', 'backdrop-blur-2xl');
        navbar.classList.remove('bg-black/40', 'shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]', 'backdrop-blur-xl');
    } else {
        // Initial State
        navbar.classList.remove('bg-black/80', 'shadow-[0_16px_40px_0_rgba(0,0,0,0.4)]', 'backdrop-blur-2xl');
        navbar.classList.add('bg-black/40', 'shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]', 'backdrop-blur-xl');
    }
});
